...
def blob():
    ...
    man = Manifest(path)
    blob: Blob = man.get(TEST_KEY)  # type: ignore
    return blob


def test_blob(blob: Blob):
    assert isinstance(blob.parent, Manifest)
